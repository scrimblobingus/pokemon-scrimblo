...
const u8 gText_AlreadySurfing[] = _("You're already using Surf.");
...
const u8 gText_Retire[] = _("Reture");
...
const u8 gText_Lv502[] = _("Lvl. 50");
const u8 gText_OpenLv[] = _("Open Lvl.");
...
ALIGNED(4) const u8 gText_RecordsLv50[] = _("Lvl. 50");
...
const u8 gText_BattleScene[] = _("Battle Speed");
...
const u8 gText_BattleScene0[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}1x");
const u8 gText_BattleScene1[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}2x");
const u8 gText_BattleScene2[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}3x");
const u8 gText_BattleScene3[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}4x");
...
const u8 gText_MenuRetire[] = _("Reture");
...
const u8 gText_HeavyRain[] = _("Heavy Rain"); // Unused and also SHAAAAAAAAAAAAAAAAWWWWWWWWWWWWWWWNNN
