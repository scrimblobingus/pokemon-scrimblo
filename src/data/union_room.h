...
ALIGNED(4) static const u8 sText_OfferToTradeMon[] = _("There is an offer to trade your\nregistered Lvl. {DYNAMIC 0} {DYNAMIC 1}\pin exchange for a\nLvl. {DYNAMIC 2} {DYNAMIC 3}.\pWill you accept this trade\noffer?");
...
ALIGNED(4) static const u8 sText_NameWantedOfferLv[] = _("Name{CLEAR_TO 60}Wanted{CLEAR_TO 110}Offer{CLEAR_TO 198}Lvl.");
...
ALIGNED(4) static const u8 sText_BattleTowerLv50[] = _("Battle Tower Lvl. 50");
